...
function TestimonialCard({
    ...
    return (
        <section className="sm:basis-[100%] md:basis-[47%] lg:basis-[32%] xl:basis-[30%] bg-navy rounded-2xl shadow-xl hover:shadow-2xl transition ease-in-out duration-500 p-6 mx-1 md:mx-2 xl:mx-3 2xl:mx-4 3xl:mx-5">
            <Image
                src={imageSrc}
                width={148}
                height={148}
...
const Testimonials = () => {
    ...
    return (
        <section id="testimonials" className="relative bg-white block w-full mx-auto">
            <div className="max-w-[1600px] testimonials-container mx-auto pt-20 sm:pt-36 md:pt-24 lg:pt-28 pb-28 sm:pb-40 md:pb-32">
                ...
                <article className="testimonials-flex flex flex-wrap justify-center sm:mt-2 md:mt-10 mx-10 sm:mx-28 lg:mx-10 xl:mx-28">

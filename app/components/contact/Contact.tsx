...
const Contact = () => {
    return (
        <>
            <div id="parentContact"></div>
            <section id="contact" className="relative block w-full mx-auto mt-2 sm:mt-4 lg:mt-6 2xl:mt-8 mb-16 md:mb-40 lg:mb-48 xl:mb-52">
                <div className="max-w-[1200px] testimonials-container mx-auto pt-0 xs:pt-4 md:pt-6 xl:pt-10 xl:pb-4">
                    ...
                    <article className="flex flex-col md:flex-row items-center justify-center mt-6 xs:mt-8 sm:mt-12 md:mt-20">
                        <figure className="flex justify-end basis-full md:basis-1/2 md:pl-4 md:pr-8 lg:pr-12 px-2 xs:px-4 pb-6 xs:pb-8 md:pb-0 border-b-4 md:border-b-0 md:border-r-4 border-white">
                            <Image
                        ...
                        <section className="basis-full md:basis-1/2 pt-4 xs:pt-6 md:pt-0 md:pl-6 lg:pr-20 xl:pr-36 2xl:pr-56">

        ...
        <footer>
            <div id="footer" className="bg-slate w-full py-4 border-t border-white z-10">
                <div className="max-w-[1600px] mx-auto flex flex-row justify-between">
                    <nav className="flex flex-row justify-evenly basis-full md:basis-2/3">
                        <section className="hidden md:flex md:flex-row w-full justify-evenly">
                            <FooterLink
                                title="Home"
                                linkTitle="/#home"
                                linkFirst="/#about"
                    ...
                    <section className="hidden md:flex flex-row justify-evenly md:basis-1/3 md:pt-2 lg:pt-6">
                ...
                <div className="max-w-[1300px] w-5/6 mx-auto block md:flex md:flex-row justify-between pb-2 lg:pb-6 mt-6">
                    ...
                    <section className="flex flex-row mt-2 xs:mt-0 items-center">

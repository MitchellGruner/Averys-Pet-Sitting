...
const ContactButton = (props: Props) => {
    return (
        <Link href="/#contactForm" onClick={handleClick} className={`inline-block mb-6 2xs:py-1 xs:py-2 sm:py-2 md:py-3 lg:py-2 2xs:px-4 sm:px-6 md:px-10 lg:px-14 2xs:mt-4 md:mt-6 lg:mt-10 text-center text-black text-md font-bold bg-white shadow-2xl uppercase hover:bg-light-brown transition ease-in-out duration-500 italic cursor-pointer ${props.class}`}>

...
const AveryVertis = () => {
    return (
        <section className="flex justify-center text-center 2xs:mt-16 2xs:mb-24 xs:mt-20 xs:mb-28 sm:mt-28 sm:mb-32 md:mb-24 lg:mt-36 lg:mb-20 relative z-0">
            ...
            />
            <figure className="absolute -bottom-20 xs:-bottom-32 z-10">
                <Image

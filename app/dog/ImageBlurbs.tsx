    ...
    return (
        <div className={`block md:flex md:flex-col lg:flex-row mt-16 sm:mt-20 md:mt-28 lg:mt-32 xl:mt-40 2xl:mt-52 ${textOrientation}`}>
            ...
            <div className="relative">
                <div className={`relative bg-navy mt-8 sm:mt-12 md:mt-16 mb-2 md:mb-4 lg:mt-0 lg:mb-0 xs:w-[20em] sm:w-[26em] md:w-[36.3em] lg:w-[28em] xl:w-[40em] 2xl:w-[50em] ${divClassName} py-4 xl:py-6 px-6 xl:px-8 rounded-xl h-fit z-[1] shadow-2xl`}>
    ...
    return (
        <div id="imageBlurbs" className="mx-8 sm:mx-0 md:mx-16 2xl:mx-24">
            ...
            <PhotoText
                ...
                divClassName="ml-14 md:mr-14 second-div"

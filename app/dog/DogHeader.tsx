        ...
        <section className="max-w-[1600px] mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-center mt-6 xs:mt-8 sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28 mx-6 xs:mx-8 sm:mx-12 md:mx-20 lg:mx-28 xl:mx-40 2xl:mx-72">
                <article className="basis-full order-2 md:order-1 md:basis-1/2 pt-4 xs:pt-6 md:pt-0 md:pr-6">
                    <span className="hidden sm:block absolute main-header text-white 2xs:top-1 xs:top-[12em] sm:top-[13.2em] md:top-0 md:left-0 lg:left-[1.2em] xl:left-[2em] 2xl:left-[4em] 4xl:left-[6em] 5xl:left-[8em] 6xl:left-[9em] 7xl:left-[11em] 8xl:left-[13em]">Tail-Wagging</span>

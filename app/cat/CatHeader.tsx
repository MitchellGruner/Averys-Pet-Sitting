        ...
        <div className="flex flex-col md:flex-row">
            ...
            <div className="cat-content-div basis-full md:basis-[55%] mt-[3em] xs:mt-[3.2em] sm:mt-[3.4em] md:mt-[-4px]">
                <div className="max-w-[1400px]">
                    ...
                    <div className="bg-brown py-8 px-4 ml-[2.8em] xs:ml-[3.2em] sm:ml-[4.2em] md:ml-[8em] lg:ml-[9em] xl:ml-[10em] 2xl:ml-[12em] w-4/6 3xl:w-3/5 4xl:w-3/6 8xl:w-1/3 mt-[3.8em] xs:mt-[4.4em] sm:mt-[15.2em] md:mt-[16em] lg:mt-[18em] xl:mt-[20em] 8xl:ml-[24em] border border-white shadow-2xl">
